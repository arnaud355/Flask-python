...
def handleFileUpload():
    if 'photo' in request.files:
        ...
        if photo.filename != '':
            photo.save(os.path.join('/Users/arnaudbaleh/python-docs-hello-world/images_upload', photo.filename))
...
def model():
    ...
    model = load_model('/Users/arnaudbaleh/python-docs-hello-world/model.h5')
    ...
    while chrono_over != 1 :
        for i in range(a.shape[0]):
            ...
            matplotlib.image.imsave("/Users/arnaudbaleh/python-docs-hello-world/static/result/img_01.png", rgb)
        chrono_over = 1
